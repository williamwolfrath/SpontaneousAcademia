// $Id: README.txt,v 1.2.2.1.2.2.2.3 2008/12/15 05:41:29 arthuregg Exp $
...
The file that the media player plays is generated by the hook_flvmediaplayer_file_use.
XSPF Playlist implements this hook, which provides a URL to the player and uses its own
system for defining how files can be choosen for the playlist. If none of the modules which
support hook_flvmediaplayer_file_use return a file to the player, a no avaliable media 
screen will be presented instead. 
