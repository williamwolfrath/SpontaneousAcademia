...
function profileHeadersHide() {
    $('table#field_profile_websites_values tbody').hide();
    $('table#field_profile_websites_values thead th').click(function() {
        $('table#field_profile_websites_values tbody').toggle('slow');
    });
    
    $('table#field_memberships_affiliations_values tbody').hide();
    $('table#field_memberships_affiliations_values thead th').click(function() {
        $('table#field_memberships_affiliations_values tbody').toggle('slow');
    });
}


function createNodeGroupsHelp() {
    $('#edit-og-groups-wrapper').append('To choose more than one group, hold down control as you click');
}
